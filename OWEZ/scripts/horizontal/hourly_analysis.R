...
sunset <- c(20071010170100,20071013165100,20071018164300,20071019164100,20071020163600,20081029000000,20081029161900,20081030161400,20080327180800,20090313174300,20090316174900,20100316174600,20100321175700,20100322174100)
...
Oct1m <- subset(means[[1]], migr.day>="2007-10-10 16:00:00" & migr.day<="2007-10-11 16:00:00", select = migr.day:Rlight)
Oct2m <- subset(means[[1]], migr.day>="2007-10-13 16:00:00 UTC" & migr.day<="2007-10-14 16:00:00 UTC" , select = migr.day:Rlight)
Oct3m <- subset(means[[1]], migr.day>="2007-10-18 16:00:00" & migr.day<="2007-10-19 16:00:00", select = migr.day:Rlight)
Oct4m<- subset(means[[1]], migr.day>="2007-10-19 16:00:00" & migr.day<="2007-10-20 16:00:00", select = migr.day:Rlight)
Oct5m <- subset(means[[1]], migr.day>="2007-10-20 16:00:00 UTC" & migr.day<="2007-10-21 16:00:00 UTC", select = migr.day:Rlight)
Oct6m <- subset(means[[2]], migr.day>="2008-10-28 16:00:00" & migr.day<="2008-10-29 16:00:00", select = migr.day:Rlight)
Oct7m <- subset(means[[2]], migr.day>="2008-10-29 16:00:00" & migr.day<="2008-10-30 16:00:00", select = migr.day:Rlight)
Oct8m <- subset(means[[2]], migr.day>="2008-10-30 16:00:00 UTC" & migr.day<="2008-10-31 16:00:00 UTC", select = migr.day:Rlight)
Mar1m <- subset(means[[2]], migr.day>="2008-03-27 16:00:00 UTC" & migr.day<="2008-03-28 16:00:00 UTC", select = migr.day:Rlight)
Mar2m <- subset(means[[3]], migr.day>="2009-03-13 16:00:00" & migr.day<="2009-03-14 16:00:00", select = migr.day:Rlight)
Mar3m <- subset(means[[3]], migr.day>="2009-03-16 16:00:00" & migr.day<="2009-03-17 16:00:00", select = migr.day:Rlight)
Mar4m <- subset(means[[4]], migr.day>="2010-03-16 16:00:00 UTC" & migr.day<="2010-03-17 16:00:00 UTC", select = migr.day:Rlight)
Mar5m <- subset(means[[4]], migr.day>="2010-03-21 16:00:00" & migr.day<="2010-03-22 16:00:00" , select = migr.day:Rlight)
Mar6m<- subset(means[[4]], migr.day>="2010-03-22 16:00:00" & migr.day<="2010-03-23 16:00:00", select = migr.day:Rlight)
