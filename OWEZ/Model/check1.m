...
for ii=1:nDays
    ...
    N=4;
    for h=1:plotTracks
        for a=1:N:stp(plotTracks,ii)-N
            plot(Long(plotTracks,stp((a:a+N),ii),ii),Lat(plotTracks,stp((a:a+N),ii),ii),'-')
        end
    end
...
%% Saving
% Figure
Filename=['M' TT '_' num2str(nanmean(as)) '_'  num2str(pl) '_2.3' '.png'];
